...
def decisionboundaries_drawing(numFigure, xRange, yRange, decisionBoundaryMap, colorMap, figsize=None):
    ...
    plt.pcolormesh(xx, yy, decisionBoundaryMap, cmap=colorMap, alpha=1, shading='auto')
    plt.draw()
...
def show_2D_results(clf, *datasets, figsize=(18, 8)):
    ...
    area_colors = color_fading(class_colors, 0.6)
...
def show_2D_results_OLD(classifier, *args, figsize=(18, 8)):
